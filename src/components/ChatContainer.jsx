    ...
    >
      {msg.image ? (
        ...
        >
         ...
         <div className="text-center trext-xs">
          <img src={`msg. senderId === authUser._ id ?  authUser?.profilePic  || assets.avatar_icon :
            slecttedUser?.profilePic || assets.avatar_icon}`} alt="" className='w-7 rounded-full' />
